...
case class MessageFromVk(id: Int, date: Int, userId: Int, body: String, emoji: Option[Int]) {
  ...
  lazy val bodyWithImg =
    if (body.isEmpty)
      ...
      replaceEmojiCodesWithImages(body, emojiToDisplay)

  def replaceEmojiCodesWithImages(str: String, emojies: Traversable[Int]): String = {
    emojies match {
      case h :: t =>
